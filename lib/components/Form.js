...
class Form extends Component {
    ...
    validate() {
        ...
        return this.setState({ isValid: allFieldsAreValid && this.props.customValidator.rule(this.state.values)});
    }

    valueUpdateHandler(name, value) {
        this.setState({ values: Object.assign({}, this.state.values, {[name]: value}) }, () => this.validate());
    }
