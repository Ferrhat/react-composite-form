...
class Form extends Component {
    ...
    generateFields() {
        return this.props.fields.map((field, i) => {
            ...
            return FormFieldFactory.build(Object.assign({}, field, { valueUpdateHandler: this.valueUpdateHandler, value, errors, changeHandler}), i);
        });
    }
    ...
    inputHandler() {
        this.setState({ isValid: this.props.customValidator.rule(this.state.values)});
    }
    ...
    render() {
        ...
        return (
            <Panel className="panel-shadow panel-blue-cap">
                ...
                <Panel.Body>
                    <form className="form-horizontal" onSubmit={this.submitHandler} onChange={this.inputHandler}>
